...
>**code** is a simple web page for generate ZiWeiDouShu Chart
by using Html+JavaScript+CSS.
>**支持批量排星** 支持批量排星(指定时间列表或者时间范围)
...
## Demo
* [ZiweiDouShu 紫微斗數](http://www.ahfrc.com/tool/zw/)
...
- 原始版本
- 將生成html與計算命盤的部分分開
- 使用另一個lunar.js，增加可計算的年份 2.將ziwei.js分拆為ziweicore.js及ziweicoreui.js
- 使用原生js函數，取代jquery
- 使用Gird排版
* 目前版本:使用寿星天文星来获取日历数据 [master]